...
const Login = () => {
  ...
  return (
    <>
      ...
      {InvalidUser && <div>
        <div className="fixed inset-0 flex items-center justify-center bg-white bg-opacity-80 backdrop-blur-md z-50">
          <p className="text-lg font-semibold text-gray-900">THIS IS AN INVALID LINK</p>
        </div>
      </div>}
      {NoVotesFound && <div>
        <div className="fixed inset-0 flex items-center justify-center bg-white bg-opacity-80 backdrop-blur-md z-50">
            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <div className="space-y-4 md:space-y-6" action="#">
                ...
                <div>
                  ...
                  <input value={UserName} onChange={(e) => setUserName(e.target.value)} type="tel" name="contact" id="contact" className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 drk:bg-gray-700 drk:border-gray-600 drk:placeholder-gray-400 drk:text-white drk:focus:ring-blue-500 drk:focus:border-blue-500" placeholder="Enter Name" required="" />
                </div>
                <div>
                  <label htmlFor="contact" className="block mb-2 text-sm font-medium text-gray-900 drk:text-white">Enter Your Email</label>
                  <input value={UserEmail} onChange={(e) => setUserEmail(e.target.value)} type="tel" name="contact" id="contact" className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 drk:bg-gray-700 drk:border-gray-600 drk:placeholder-gray-400 drk:text-white drk:focus:ring-blue-500 drk:focus:border-blue-500" placeholder="Enter Email" required="" />
                </div>




                <button className="w-full text-white bg-blue-500 hover:bg-blue-7600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md px-5 py-2.5 text-center drk:bg-blue-600 drk:hover:bg-blue-700 drk:focus:ring-blue-800">{Loading ? "Please Wait" : "Get Voting Link"}</button>
